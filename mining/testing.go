...
func (bg *MockBlockGenerator) Generate(ctx context.Context, h types.TipSet, ticket types.Signature, nullBlockCount uint64, a types.Address) (b *types.Block, err error) {
