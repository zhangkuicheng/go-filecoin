...
import (
	...
	"github.com/filecoin-project/go-filecoin/plumbing/config"
...
func New(sigGetter *mthdsig.Getter, msgSender *msg.Sender, msgWaiter *msg.Waiter, cfg *config.Config) *API {
	return &API{
